...
#define PROGRAM_FILE "rotate.cl"
#define KERNEL_FUNC "rotate_image"
...
int main(int argc, char **argv) {
   ...
   err |= clSetKernelArg(kernel, 2, sizeof(float), &sin_theta);
   err |= clSetKernelArg(kernel, 3, sizeof(float), &cos_theta);
   if(err < 0) {
